...
from urban_mapper.modules import RegionNeighborhoods
import pytest


@pytest.mark.skip()
class TestRegionNeighborhoods:
  """
    It tests a RegionCities class.

  """
  layer = RegionNeighborhoods()
  ...
  def test_map_nearest_layer(self):
    ...
    """
        Geometry columns
    """
    self.layer = RegionNeighborhoods() # It is not possible to map the same layer twice
