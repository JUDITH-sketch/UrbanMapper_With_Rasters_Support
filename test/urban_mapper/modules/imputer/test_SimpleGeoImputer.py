...
class TestSimpleGeoImputer:
  ...
  def test_transform(self):
    """
        Lat/Long columns
    """    
    imputer = SimpleGeoImputer(latitude_column="latitude", longitude_column="longitude")
  ...
  def test_preview(self):
    loader = SimpleGeoImputer(longitude_column="longitude", latitude_column="latitude")
